...
function Navbar() {
  ...
  return (
    <nav className="sticky bg-black top-0 z-50 flex justify-center px-4 pt-4">
      <main className="w-full max-w-6xl flex items-center justify-between
        ...
        <section className="flex items-center gap-4">
          {location.pathname !== '/learn' && (
            <Link to="/learn" className="hidden sm:inline-flex text-white/50 hover:text-white text-sm font-medium transition-colors duration-150 px-3 py-1.5">
              Learn Layers
            </Link>
          )}
          {!user && (
